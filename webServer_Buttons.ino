        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (pds=="off") {
              ...
              client.println("<p><a href=\"/26/off\"><button class=\"button button2\">Aquiring</button></a></p>");
            } 
            ...
            if (cds=="off") {
              ...
              client.println("<p><a href=\"/27/off\"><button class=\"button button2\">Aquiring</button></a></p>");
            }
